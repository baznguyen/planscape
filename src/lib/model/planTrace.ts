...
export const PLAN_TRACE: TraceSeg[] = [
  ...
  S(0, 'internal', 25.93, 5.13, 25.93, 10.81, 'garage street wall carrying the panel lift door; the strip east of it is marked LINE OF DWELLING OVER'),
  ...
  S(0, 'internal', 17.78, 0, 17.78, 2.92, 'guest wing west wall, chain 3,870'),
  S(0, 'internal', 17.78, 5.6, 17.78, 11.0, 'service band west wall, chain 220 + 2,070'),
  S(0, 'internal', 20.09, 5.13, 20.09, 11.0, 'garage west wall; line detected at x=20,094 from the sheet'),
  S(0, 'internal', 17.85, 7.42, 20.09, 7.42, 'PDR / WIL divider; line detected at z=7,420'),
  S(0, 'internal', 18.55, 7.42, 18.55, 9.56, 'LINEN / WIL divider; line detected at x=18,552'),
  S(0, 'internal', 17.85, 9.56, 20.09, 9.56, 'WIL / L-DRY divider; line detected at z=9,560'),
  S(0, 'internal', 20.09, 5.13, 25.93, 5.13, 'garage south wall; line detected at z=5,133'),
  S(0, 'internal', 17.85, 2.92, 25.93, 2.92, 'bedroom wing corridor wall; band measured 2,700 / 2,460 / 5,400 = 10,560 internal'),
  ...
  // ---------------- first floor shell ----------------
  S(1, 'external', 6.6, 0.72, 27.58, 0.72, 'first floor south; plate runs 21,640 to x=27.58 per detected line at x_src 3946'),
  S(1, 'external', 6.6, 10.28, 27.58, 10.28, 'first floor north'),
  S(1, 'external', 27.58, 0.72, 27.58, 3.0, 'first floor street wall south of balcony'),
  S(1, 'external', 27.58, 6.0, 27.58, 10.28, 'first floor street wall north of balcony'),
  ...
  S(1, 'internal', 11.7, 5.0, 15.1, 5.0, 'study north wall, chain 3,850'),
  S(1, 'internal', 15.1, 0.72, 15.1, 4.5, 'study east wall'),
  S(1, 'internal', 16.3, 6.35, 16.3, 10.28, 'BED 2 east wall, chain 3,010'),
  S(1, 'internal', 16.3, 7.9, 19.1, 7.9, 'bathroom south wall'),
  S(1, 'internal', 19.1, 7.9, 19.1, 10.28, 'BED 4 west wall, chain 2,340 + 140'),
  S(1, 'internal', 13.0, 6.35, 21.5, 6.35, 'landing / stair void edge'),
  S(1, 'internal', 19.5, 5.0, 19.5, 6.35, 'principal suite west wall'),
  S(1, 'internal', 19.5, 5.0, 25.95, 5.0, 'principal suite north wall, chain 3,910'),
  S(1, 'internal', 19.5, 0.72, 19.5, 5.0, 'principal suite / study wall'),
  S(1, 'internal', 19.6, 2.45, 21.7, 2.45, 'WIR 1 north wall'),
  S(1, 'internal', 21.7, 0.72, 21.7, 2.45, 'WIR 1 / ENS wall'),
  S(1, 'internal', 25.95, 0.72, 25.95, 5.0, 'balcony threshold wall'),
  S(1, 'internal', 25.95, 6.0, 25.95, 10.28, 'BED 4 east wall'),
  S(1, 'internal', 18.4, 6.35, 18.4, 7.9, 'WIR 2 east wall'),
];
