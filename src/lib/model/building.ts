...
export const ROOMS: Room[] = [
  ...
  R('f_bd2','Bedroom 2',1,11.7,16.2,5.2,10.1,'bed','carpet',['bed','robe','desk','curtain'],1,{tour:true}),
  R('f_wr2','WIR 2',1,16.4,18.4,5.2,6.6,'store','carpet',['robe']),
  R('f_bth','Bathroom',1,16.4,19.0,6.8,10.1,'bath','ceramicTile',['bath'],0,{tour:true,skylight:true}),
  R('f_bd4','Bedroom 4',1,19.2,23.4,6.5,10.1,'bed','carpet',['bed','robe','curtain'],1,{tour:true}),
  R('f_lnd','Landing',1,15.2,21.5,4.4,6.3,'hall','timberFloor',[],0,{skylight:true}),
...
export const WALLS: Wall[] = [
  ...
  W('fi_6',1,11.7,4.5,15.1,4.5,'studWall',false,'N'),
  W('fi_7',1,15.1,0.72,15.1,4.5,'studWall',false,'E'),
  W('fi_8',1,16.3,5.1,16.3,10.28,'studWallAcoustic',false,'E'),
  W('fi_9',1,16.3,6.7,19.1,6.7,'studWallAcoustic',false,'N'),
  W('fi_10',1,19.1,6.7,19.1,10.28,'studWallAcoustic',false,'E'),
  W('fi_11',1,15.2,6.35,21.5,6.35,'studWall',false,'N'),
...
export const OPENINGS: Opening[] = [
  ...
  O('d_f2',1,'fi_6',13.4,4.5,0.9,2.34,0,'door','doorSolid',0.9,'f_std','f_lnd','N'),
  O('d_f3',1,'fi_11',13.9,6.35,0.9,2.34,0,'door','doorSolid',0.9,'f_lnd','f_bd2','N'),
  O('d_f4',1,'fi_9',17.6,6.7,0.8,2.34,0,'door','doorSolid',0.9,'f_wr2','f_bth','N'),
  O('d_f5',1,'fi_13',21.0,4.3,0.9,2.34,0,'door','doorSolid',0.9,'f_lnd','f_pri','N'),
  O('d_f6',1,'fi_12',19.5,5.3,0.9,2.34,0,'door','doorSolid',0.9,'f_lnd','f_bd4','E'),
  ...
  O('d_f9',1,'fi_17',18.4,5.9,0.7,2.34,0,'door','doorSolid',0.9,'f_bd2','f_wr2','E'),
];
